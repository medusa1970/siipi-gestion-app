<template>
          ...
          <q-item-section side>
            <div class="row items-center">
              <q-icon
                ...
                @click.stop="modalCrearCatalogo(categoria)"
              />
            </div>
          </q-item-section>
        </template>
              ...
              <q-item-section side>
                <div class="row items-center">
                  <q-icon
                    ...
                    size="17px"
                    class="transition-all duration-300 ease-in-out transform hover:scale-125 hover:opacity-100 opacity-75 bg-green-600 text-white rounded-full"
                    @click.stop="modalCrearCatalogo(item)"
                  />
                  <q-icon
                    name="edit"
                    color="primary"
                    ...
                    @click.stop="modalEditarCatalogo(item)"
                  />
                  <q-icon
                  ...
                  <q-item-section side>
                    <div class="row items-center">
                      <q-icon
                        ...
                        size="17px"
                        class="transition-all duration-300 ease-in-out transform hover:scale-125 hover:opacity-100 opacity-75"
                        @click.stop="modalEditarCatalogo(item2)"
                      />
                      <q-icon
  ...
  <q-dialog persistent v-model="estado.modal.esEditarCatalogo">
    <q-card class="p-3 w-[380px]">
      <div class="flex justify-between">
