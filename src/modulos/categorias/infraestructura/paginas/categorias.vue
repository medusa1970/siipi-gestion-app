<template>
  ...
  <!-- <Dialog
    :title="
      estado.modal.show_modificarCategoriaCatalogo
        ? 'Editar categoria'
        : 'Agregar categoria'
    "
    v-model="estado.modal.show_agregarCategoriaCatalogo"
    :handle-submit="
      estado.modal.show_modificarCategoriaCatalogo
...
<script setup>
import { useCatalogos } from '@/modulos/catalogos/negocio/catalogos.composable';
