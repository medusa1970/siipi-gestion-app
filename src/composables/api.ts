...
export const api = {
   ...
   */
  buscarPedido: async (
    b: string | BuscarPedidoDto,
    o: BuscarOpciones & { loading?: boolean } = {},
    f: BuscarPedidoDto = {},
    t: any = null
  ): Promise<Pedido> =>
    <Pedido>await bu(GqlBuscarPedidos, t, b, o, f, o.loading),
  buscarPedidos: async (
    b: BuscarPedidoDto,
    o: BuscarOpciones & { loading?: boolean } = {},
    f: BuscarPedidoDto = {},
    ...
    <Pedido[]>await bv(GqlBuscarPedidos, t, b, o, f, o.loading),
  crearPedido: async (
    d: CrearPedidoDto,
    o: CrearOpciones & { loading?: boolean } = {},
    t: any = null
  ): Promise<Pedido> => <Pedido>await cu(GqlCrearPedidos, t, d, o, o.loading),
  crearPedidos: async (
    d: CrearPedidoDto,
    o: CrearOpciones & { loading?: boolean } = {},
    t: any = null
  ): Promise<Pedido[]> =>
    <Pedido[]>await cv(GqlCrearPedidos, t, d, o, o.loading),
  modificarPedido: async (
    b: string | BuscarPedidoDto,
    d: ModificarPedidoDto,
    o: ModificarOpciones & { loading?: boolean } = {},
    t: any = null
  ): Promise<Pedido> =>
    <Pedido>await mu(GqlModificarPedidos, t, b, d, o, o.loading),
  modificarPedidos: async (
    b: BuscarPedidoDto,
    d: ModificarPedidoDto,
    o: ModificarOpciones & { loading?: boolean } = {},
    t: any = null
  ): Promise<Pedido[]> =>
    <Pedido[]>await mv(GqlModificarPedidos, t, b, d, o, o.loading),
  borrarPedido: async (
    b: string | BuscarPedidoDto,
    o: BorrarOpciones & { loading?: boolean } = {},
    t: any = null
  ): Promise<Pedido> => <Pedido>await du(GqlBorrarPedidos, t, b, o, o.loading),
  borrarPedidos: async (
    b: BuscarPedidoDto,
    o: BorrarOpciones & { loading?: boolean } = {},
    t: any = null
